...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/uslugi/mehovoj-holodilnik/hranenie-norkovoj-shuby`, changeFrequency: 'monthly' as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/nasha-masterskaya`, changeFrequency: 'monthly' as const, priority: 0.6 },
