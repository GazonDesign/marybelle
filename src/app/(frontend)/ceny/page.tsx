...
const poshivCategory = {
  ...
  items: [
    ...
    { label: 'Пошив шубы из шиншиллы', price: '~~от 300 000 ₽~~ от 210 000 ₽' },
    { label: 'Пошив шубы из каракуля', price: '~~от 150 000 ₽~~ от 105 000 ₽' },
    { label: 'Пошив шубы из лисы / песца', price: '~~от 135 500 ₽~~ от 95 000 ₽' },
    { label: 'Меховой жилет', price: '~~от 78 500 ₽~~ от 55 000 ₽' },
    { label: 'Болеро / меховая накидка', price: '~~от 64 500 ₽~~ от 45 000 ₽' },
    { label: 'Меховой палантин', price: '~~от 50 000 ₽~~ от 35 000 ₽' },
    { label: 'Пошив пальто (шерсть / кашемир)', price: '~~от 128 500 ₽~~ от 90 000 ₽' },
    { label: 'Пальто с меховой отделкой', price: '~~от 128 500 ₽~~ от 90 000 ₽' },
    { label: 'Куртка (мех + кожа)', price: '~~от 107 000 ₽~~ от 75 000 ₽' },
    { label: 'Пончо / кейп с мехом', price: '~~от 93 000 ₽~~ от 65 000 ₽' },
...
const fallbackCategories = [
  ...
  },
  {
    ...
    items: [
      { label: 'Пришить вешалку (без стоимости)', price: '~~900 ₽~~ 600 ₽' },
      { label: 'Изготовить и пришить вешалку', price: '~~1 400 ₽~~ 1 000 ₽' },
      { label: 'Замена крючка шубного', price: '~~2 100 ₽~~ 1 500 ₽' },
      { label: 'Замена крючка обтяжного', price: '~~1 300 ₽~~ 900 ₽' },
      { label: 'Замена кулиски', price: '~~2 100 ₽~~ 1 500 ₽' },
      { label: 'Замена пуговицы', price: '~~1 100 ₽~~ 750 ₽' },
      { label: 'Замена фурнитуры', price: '~~1 400 ₽~~ 950 ₽' },
      { label: 'Зашить разрыв (2/4/6/8–10 см)', price: '~~2 900 / 2 100 / 2 600 / 4 300 ₽~~ 2 000 / 1 500 / 1 800 / 3 000 ₽' },
      { label: 'Поставить заплатку (4×4/6×6/8×8 см)', price: '~~5 000 / 8 000 / 12 000 ₽~~ 3 500 / 5 500 / 8 500 ₽' },
      { label: 'Замена плечиков', price: '~~от 1 600 ₽~~ от 1 100 ₽' },
    ],
  },
  {
    categoryName: 'Низ изделия', href: '/uslugi/remont-shub', sortOrder: 3, slug: 'niz-izdeliya',
    items: [
      { label: 'Укоротить/удлинить низ (подкладка наглухо)', price: '~~от 18 500 ₽~~ от 13 000 ₽' },
      { label: 'Укоротить/удлинить низ (подкладка отлетная)', price: '~~от 21 500 ₽~~ от 15 000 ₽' },
      { label: 'Ремонт шлицы', price: '~~от 11 500 ₽~~ от 8 000 ₽' },
      { label: 'Реставрация низа', price: '~~от 17 000 ₽~~ от 12 000 ₽' },
    ],
  },
  {
    categoryName: 'Рукава и плечи', href: '/uslugi/remont-shub', sortOrder: 4, slug: 'rukava-i-plechi',
    items: [
      { label: 'Укоротить/удлинить рукава без манжет', price: '~~от 8 500 ₽~~ от 5 800 ₽' },
      { label: 'Укоротить/удлинить рукава с манжетами', price: '~~от 10 500 ₽~~ от 7 200 ₽' },
      { label: 'Заузить/расширить', price: '~~от 8 500 ₽~~ от 6 000 ₽' },
      { label: 'Коррекция оката проймы', price: '~~от 11 000 ₽~~ от 7 800 ₽' },
      { label: 'Реставрация низа без манжет', price: '~~от 6 000 ₽~~ от 4 200 ₽' },
      { label: 'Реставрация низа с манжетами', price: '~~от 9 000 ₽~~ от 6 200 ₽' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Ушить по среднему шву', price: '~~от 9 500 ₽~~ от 6 800 ₽' },
      { label: 'Ушить по среднему шву с разрезом', price: '~~от 9 500 ₽~~ от 6 800 ₽' },
      { label: 'Выравнивание бортов', price: '~~от 20 000 ₽~~ от 14 000 ₽' },
      { label: 'Реставрация бортов', price: '~~от 14 500 ₽~~ от 10 000 ₽' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { label: 'Изменение выреза горловины', price: '~~от 11 000 ₽~~ от 7 700 ₽' },
      { label: 'Изменить фасон воротника', price: '~~от 14 500 ₽~~ от 10 000 ₽' },
      { label: 'Замена воротника', price: '~~от 18 500 ₽~~ от 13 000 ₽' },
      { label: 'Изготовить воротник без подкладки', price: '~~от 18 500 ₽~~ от 13 000 ₽' },
      { label: 'Изготовить воротник с подкладкой', price: '~~от 20 000 ₽~~ от 14 000 ₽' },
    ],
  },
  {
    categoryName: 'Капюшон', href: '/uslugi/remont-shub', sortOrder: 8, slug: 'kapyushon',
    items: [
      { label: 'Изменить фасон капюшона', price: '~~от 24 000 ₽~~ от 16 800 ₽' },
  ...
  },
  {
    ...
    items: [
      { label: 'Изготовить опушку', price: '~~от 10 000 ₽~~ от 7 000 ₽' },
      { label: 'Пришить опушку', price: '~~от 8 500 ₽~~ от 6 000 ₽' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Замена подкладки в карманах', price: '~~4 300 ₽~~ 3 000 ₽' },
      { label: 'Изготовление карманов', price: '~~9 500 ₽~~ 6 500 ₽' },
    ],
  },
  {
    categoryName: 'Ластовицы и другое', href: '/uslugi/remont-shub', sortOrder: 11, slug: 'lastovicy',
    items: [
      { label: 'Ремонт 2 подмышек с добавлением меха', price: '~~25 500 ₽~~ 18 000 ₽' },
      { label: 'Ушить рукава по внутренним швам', price: '~~10 500 ₽~~ 7 500 ₽' },
      { label: 'Уменьшить в плечах', price: '~~от 10 500 ₽~~ от 7 500 ₽' },
      { label: 'Ушить по боковым швам', price: '~~от 17 000 ₽~~ от 12 000 ₽' },
    ],
  },
  {
    categoryName: 'Хранение шуб', href: '/uslugi/mehovoj-holodilnik', sortOrder: 12, slug: 'hranenie',
    items: [
      { label: 'Хранение шубы (сезон, апрель–октябрь)', price: '~~от 6 500 ₽~~ от 5 000 ₽' },
      { label: 'Хранение дублёнки (сезон)', price: '~~от 4 700 ₽~~ от 3 500 ₽' },
      { label: 'Забор курьером по Москве', price: '~~2 100 ₽~~ 1 500 ₽' },
      { label: 'Доставка обратно', price: '~~2 100 ₽~~ 1 500 ₽' },
    ],
  },
  {
