...
const faqItems = [
  ...
  {
    question: 'У меня, кажется, уже завелась моль. Вы возьмёте такую шубу?',
    answer:
      'Да, привозите — осмотр бесплатный. Мастер оценит, есть ли повреждения и насколько они серьёзны, честно скажет, что можно восстановить. Перед закладкой в холодильник каждое изделие проходит антимольную обработку, уничтожающую яйца и личинок, — заражённая вещь не попадёт в камеру к другим шубам, не переживайте. Чем раньше привезёте, тем меньше успеет пострадать мех.',
  },
  {
    question: 'Какие документы я получу на руки?',
    answer:
      'При приёме составляется квитанция с описью изделия и его состояния, плюс фотофиксация со всех сторон — вы получаете экземпляр на руки. Забирая шубу, вы сверяете её состояние с описью и фото. Изделие застраховано на весь срок хранения.',
  },
]
