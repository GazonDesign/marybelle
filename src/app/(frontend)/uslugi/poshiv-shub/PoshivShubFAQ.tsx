...
const faqItems = [
  {
    ...
    answer: 'Пошив шубы из норки начинается от 130 000 ₽. Итоговая стоимость зависит от выбранного вида норки, длины изделия, сложности модели и дополнительных элементов (капюшон, пояс, декор). Точную стоимость мастер рассчитает после консультации.',
  },
  {
  ...
  {
    question: 'Шьёте ли вы на нестандартную фигуру — высокий рост, размеры 50+?',
    answer:
      'Да, это одна из главных причин заказывать шубу у нас, а не искать в магазине. Мы снимаем более 30 мерок и строим индивидуальные лекала — размерных сеток нет вообще, шуба садится именно по вашей фигуре: любой рост, любой размер, любые пропорции. Отдельная витрина больших размеров есть и в нашем магазине готовых изделий, но пошив по меркам всегда точнее.',
  },
]
