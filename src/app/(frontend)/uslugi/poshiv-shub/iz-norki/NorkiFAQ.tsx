...
const faqItems = [
  {
    ...
    answer: 'Стоимость зависит от длины изделия, типа норки и сложности фасона. Полушубок (70 см) — от 130 000 ₽, шуба до колена (90 см) — от 170 000 ₽, миди (110 см) — от 200 000 ₽, шуба в пол — от 230 000 ₽. Точную стоимость мастер назовёт после выбора меха и обсуждения модели — до начала работ вы будете знать финальную цену.',
  },
  {
