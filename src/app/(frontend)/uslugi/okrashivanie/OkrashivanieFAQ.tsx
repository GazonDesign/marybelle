...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Стоимость полного окрашивания норковой шубы — от 50 000 рублей. Тонирование обойдётся от 15 000 рублей, окрашивание жилета — от 30 000 рублей, кожаных элементов — от 4 000 рублей. Точная цена зависит от размера изделия, типа меха и сложности работы. Мастер назовёт стоимость после осмотра.',
  },
  {
