...
const faqItems = [
  ...
  {
    question: 'Как проходит перекрой — я увижу, что получится, до начала работ?',
    answer:
      'Да. Сначала бесплатная диагностика: мастер осматривает шубу и вместе с вами подбирает будущий фасон — что укоротить, как изменить силуэт, какой воротник. Все решения фиксируются до начала работ, и вы знаете итоговую цену заранее. Дальше перекрой и примерка: изделие сажают по вашей фигуре. Ничего не переделывается «на глазок» без согласования с вами.',
  },
  {
    question: 'А если результат мне не понравится?',
    answer:
      'Посадка по фигуре — часть работы: на примерке мастер подгоняет изделие до тех пор, пока вы не будете довольны, это входит в стоимость. Фасон при этом не сюрприз — он согласован с вами до первого разреза. На работы действует гарантия, а если на диагностике мастер увидит, что желаемый фасон из вашего меха не получится, он честно скажет об этом до начала работ.',
  },
  {
    question: 'Вы перекраиваете только норку? У меня соболь',
    answer:
      'Работаем с любым мехом: норка, соболь, каракуль, песец, лиса, мутон. Соболь — самый ценный мех, и именно поэтому его перекрой стоит доверять фабрике, а не частному мастеру: у нас скорняки с опытом работы с соболем, перекрой ведётся с минимальным расходом меха. Стоимость для соболя рассчитывается индивидуально после осмотра.',
  },
]
