...
const faqItems = [
  ...
  {
    question: 'Берёте ли вы брендовые дублёнки — прожоги, потёртости?',
    answer:
      'Да. Дублёнки и кожаные вещи премиальных марок (Massimo Dutti, Max Mara и других) — наш профиль: фабрика работает с кожей и мехом с 1870 года. Прожоги, потёртости, повреждения рукавов ремонтируем с подбором материала в тон, сохраняя оригинальную фурнитуру. Привозите на бесплатный осмотр — мастер оценит повреждение и скажет, каким будет результат.',
  },
]
