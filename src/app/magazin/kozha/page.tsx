...
export const metadata = {
  title: 'Кожаные изделия — Куртки, жакеты из кожи в Москве | Mary Belle',
  description: 'Кожаные куртки, жакеты, юбки из натуральной кожи и замши. Собственное производство фабрики Mary Belle. Москва, м. Войковская.',
}
