...
export const metadata = {
  title: 'Пальто — Купить женское пальто в Москве | Mary Belle',
  description: 'Женские пальто от фабрики Mary Belle. Шерстяные и кашемировые пальто собственного производства. Примерка в ателье, Москва, м. Войковская.',
}
