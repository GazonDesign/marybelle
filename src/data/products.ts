...
export const products: Product[] = [
  // === ШУБЫ ИЗ НОРКИ ===
  {
    slug: 'odeyalo-pudra',
    title: '«Одеяло» Пудра',
    description: 'Шуба-одеяло из норки пудрового оттенка. Свободный крой оверсайз, мягкий и уютный силуэт.',
    category: 'shuby',
    subcategory: 'norka',
    images: imgs('/images/magazin/shuby/odeyalo-pudra', 3),
    price: 'Цена по запросу',
    details: ['Мех: норка', 'Цвет: пудра', 'Крой: оверсайз', 'Длина: до колена'],
  },
  {
